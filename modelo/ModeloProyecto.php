...
class ModeloProyecto {
        ...
        foreach ($idsColaboradores as $idColaborador) {
            ...
            if ($stmtAsignacion->execute()) {
                ...
                ModeloNotificacion::crearNotificacion(
                    $idColaborador,
                    'Se te ha asignado un nuevo proyecto: ' . $datos['nombre'] . '.',
                    'proyecto_asignado'
                );
            }
        }
    ...
    public static function actualizarTerminadoColaborador(int $idProyecto, int $idColaborador, bool $terminado): array {
        ...
        $estadoAntes = self::obtenerEstadoGeneralProyectoInterno($conexion, $idProyecto);
        ...
        if ($terminado && $estadoAntes !== 'Finalizado' && $estadoDespues === 'Finalizado') {
            ...
            ModeloNotificacion::enviarAAdmins(
                'El proyecto "' . $nombreProyecto . '" ha sido finalizado.',
                'proyecto_terminado'
            );
        }
