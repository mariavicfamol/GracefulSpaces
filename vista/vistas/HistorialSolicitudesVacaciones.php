...
$solicitudes = ModeloSolicitudVacaciones::obtenerSolicitudesTrabajador($idTrabajador);
...
<main class="contenedor-principal">
    ...
    <div class="filtros-seccion">
        ...
        <div class="botones-filtro">
            <a href="?estado=" class="btn-filtro <?= empty($_GET['estado']) ? 'activo' : '' ?>">Todas</a>
            <a href="?estado=Pendiente" class="btn-filtro <?= ($_GET['estado'] ?? '') === 'Pendiente' ? 'activo' : '' ?>">Pendientes</a>
            <a href="?estado=Aprobada" class="btn-filtro <?= ($_GET['estado'] ?? '') === 'Aprobada' ? 'activo' : '' ?>">Aprobadas</a>
            <a href="?estado=Rechazada" class="btn-filtro <?= ($_GET['estado'] ?? '') === 'Rechazada' ? 'activo' : '' ?>">Rechazadas</a>
        </div>
    </div>
