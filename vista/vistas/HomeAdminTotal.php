...
$noLeidas = ModeloNotificacion::contarNotificacionesNoLeidas((int)$usuario['id']);
?>
<!DOCTYPE html>
<html lang="es">
<head>
            ...
            <ul class="lista-menu">
                ...
                <li class="item-menu">
                    <a href="Notificaciones.php" class="enlace-menu">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 7h18s-3 0-3-7"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>
                        <span>Notificaciones</span>
                        <?php if ($noLeidas > 0): ?><span class="badge-notificaciones"><?= $noLeidas ?></span><?php endif; ?>
                    </a>
                </li>
                <?php endif; ?>
                <?php endif; ?>
